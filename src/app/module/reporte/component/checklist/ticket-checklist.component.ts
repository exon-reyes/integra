          ...
          <div class="space-y-3">
            @for (actividad of checklist?.actividades; track actividad.id || $index) {
              <div
                ...
                <p-checkbox [(ngModel)]="actividad.completada" (onChange)="onActividadChange(actividad, $event)"
                            [disabled]="actualizando()" [binary]="true"></p-checkbox>
                <div class="flex-1">
                  <p class="text-sm font-medium text-gray-900" [class.line-through]="actividad.completada"
