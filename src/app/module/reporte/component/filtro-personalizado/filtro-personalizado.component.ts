...
export class FiltroPersonalizadoComponent implements OnInit, OnDestroy {
    ...
    constructor(private formBuilder: FormBuilder, private filtroService: FiltroPersonalizadoService, private unidadService: UnidadService, private estatusService: EstatusService, // private areaService: AreaService,
                private zonaService: ZonaService, private supervisorService: EmpleadoService, private departamentoService: DepartamentoService) {
        this.initForm();
    }
